    ...
    <CustomerLayout>
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 xl:grid-cols-6 gap-5">
          ...
          <div className="bg-white rounded-xl shadow p-5">
            <p className="text-gray-500 text-sm">Favorite Workers</p>
        ...
        {upcomingBooking && (
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
            ...
            <p className="text-gray-600">{upcomingBooking.booking_date}</p>

            <p className="text-gray-600">{upcomingBooking.booking_time}</p>
            {(() => {
        ...
        <div className="bg-white rounded-2xl shadow p-6">
          <div className="flex justify-between items-center mb-5">
            <h2 className="text-2xl font-bold">Featured Workers</h2>
        ...
        <div className="bg-white rounded-2xl shadow p-6">
          <h2 className="text-2xl font-bold mb-5">Recently Viewed Workers</h2>

          {recentWorkers.length === 0 ? (
            <p className="text-gray-500">No recently viewed workers.</p>
          ) : (
