  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-2 gap-5">
        <UploadCard title="Valid ID" field="validId" />

        <UploadCard title="Resume" field="resume" />

        <UploadCard title="TESDA Certificate" field="tesdaCertificate" />

        <UploadCard title="Barangay Clearance" field="barangayClearance" />

        <UploadCard title="Police Clearance" field="policeClearance" />

        <UploadCard title="NBI Clearance" field="nbiClearance" />
      </div>
...
function UploadCard({ title, field }: UploadCardProps) {
