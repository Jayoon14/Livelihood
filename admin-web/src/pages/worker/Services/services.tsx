...
export default function Services() {
  ...
  async function saveService() {
    if (!category || !serviceName || !description || !price) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          ...
          <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all p-5 border">
            <div className="flex justify-between items-center">
              ...
              <CircleCheck size={45} className="text-green-600" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all p-5 border">
            <div className="flex justify-between items-center">
              ...
              <Clock3 size={45} className="text-yellow-500" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all p-5 border">
            <div className="flex justify-between items-center">
              ...
              <CircleX size={45} className="text-red-600" />
            </div>
          </div>
        </div>
        {/* ADD SERVICE FORM */}
        ...
        <div className="bg-white rounded-2xl shadow-lg border-l-4 border-blue-600 p-6">
          ...
          {filteredServices.length === 0 && (
            <div className="py-16 text-center">
              ...
              <h2 className="text-2xl font-bold mt-4">No Services Yet</h2>
