      ...
      <Section title="👤 Personal Information">
        <div className="grid grid-cols-2 gap-6">
          ...
          <Info
            ...
            value={
              customer.birth_date
                ? new Date(customer.birth_date).toLocaleDateString("en-GB")
                : "-"
            }
          />

          <Info title="Civil Status" value={customer.civil_status} />

          <Info title="Religion" value={customer.religion} />

          <Info title="House No." value={customer.house_no} />

          <Info title="Street" value={customer.street} />

          <Info title="Barangay" value={customer.barangay} />

          <Info title="Municipality" value={customer.municipality} />

          <Info title="Province" value={customer.province} />
        </div>
      </Section>
